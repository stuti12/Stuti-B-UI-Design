...
class LoginViewController: UIViewController {
    ...
    @IBAction func btnSignUp(_ sender: UIButton) {
        ...
        let storyboard = UIStoryboard(name: Constants.signUpStory, bundle: nil)
        if let vc = storyboard.instantiateViewController(withIdentifier: Constants.signUpVC) as? SignUpViewController {
