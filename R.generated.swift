...
struct R: Rswift.Validatable {
  ...
  struct image {
    ...
    /// Image `bg-1`.
    static let bg1 = Rswift.ImageResource(bundle: R.hostingBundle, name: "bg-1")
    /// Image `bg-2`.
    static let bg2 = Rswift.ImageResource(bundle: R.hostingBundle, name: "bg-2")
    /// Image `bg-3`.
    static let bg3 = Rswift.ImageResource(bundle: R.hostingBundle, name: "bg-3")
    /// Image `bg`.
    ...
    /// Image `food-1`.
    static let food1 = Rswift.ImageResource(bundle: R.hostingBundle, name: "food-1")
    /// Image `food-2`.
    static let food2 = Rswift.ImageResource(bundle: R.hostingBundle, name: "food-2")
    /// Image `food-3`.
    static let food3 = Rswift.ImageResource(bundle: R.hostingBundle, name: "food-3")
    /// Image `food`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "bg-1", bundle: ..., traitCollection: ...)`
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "bg-2", bundle: ..., traitCollection: ...)`
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "bg-3", bundle: ..., traitCollection: ...)`
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "food-1", bundle: ..., traitCollection: ...)`
    static func food1(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.food1, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "food-2", bundle: ..., traitCollection: ...)`
    static func food2(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.food2, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "food-3", bundle: ..., traitCollection: ...)`
    static func food3(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.food3, compatibleWith: traitCollection)
    }
    #endif
  ...
  struct reuseIdentifier {
    /// Reuse identifier `OnBoardingCollectionCell`.
    static let onBoardingCollectionCell: Rswift.ReuseIdentifier<OnBoardingCollectionCell> = Rswift.ReuseIdentifier(identifier: "OnBoardingCollectionCell")
    /// Reuse identifier `ProfileCollectionViewCell`.
    static let profileCollectionViewCell: Rswift.ReuseIdentifier<ProfileCollectionViewCell> = Rswift.ReuseIdentifier(identifier: "ProfileCollectionViewCell")
  ...
  struct string {
    ...
    struct localizable {
      /// Value: Email address or Password cant be empty
      static let emailAddressOrPasswordCantBeEmpty = Rswift.StringResource(key: "Email address or Password cant be empty", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: Registration done
      static let registrationDone = Rswift.StringResource(key: "Registration done", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)

      /// Value: Email address or Password cant be empty
      static func emailAddressOrPasswordCantBeEmpty(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("Email address or Password cant be empty", bundle: hostingBundle, comment: "")
        }

        guard let (_, bundle) = localeBundle(tableName: "Localizable", preferredLanguages: preferredLanguages) else {
          return "Email address or Password cant be empty"
        }

        return NSLocalizedString("Email address or Password cant be empty", bundle: bundle, comment: "")
      }

      /// Value: Registration done
      static func registrationDone(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("Registration done", bundle: hostingBundle, comment: "")
        }
        ...
        return NSLocalizedString("Registration done", bundle: bundle, comment: "")
      }
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct profile: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let bundle = R.hostingBundle
      let name = "Profile"
      let profileSecondScreenViewController = StoryboardViewControllerResource<ProfileSecondScreenViewController>(identifier: "ProfileSecondScreenViewController")
      let profileViewController = StoryboardViewControllerResource<ProfileViewController>(identifier: "ProfileViewController")

      func profileSecondScreenViewController(_: Void = ()) -> ProfileSecondScreenViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: profileSecondScreenViewController)
      }
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "bg", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'bg' is used in storyboard 'Profile', but couldn't be loaded.") }
        if #available(iOS 13.0, *) { if UIKit.UIImage(systemName: "house") == nil { throw Rswift.ValidationError(description: "[R.swift] System image named 'house' is used in storyboard 'Profile', but couldn't be loaded.") } }
        if #available(iOS 11.0, tvOS 11.0, *) {
          if UIKit.UIColor(named: "System-theme", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Color named 'System-theme' is used in storyboard 'Profile', but couldn't be loaded.") }
        }
        if _R.storyboard.profile().profileSecondScreenViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'profileSecondScreenViewController' could not be loaded from storyboard 'Profile' as 'ProfileSecondScreenViewController'.") }
    ...
    struct signup: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "facebook", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'facebook' is used in storyboard 'Signup', but couldn't be loaded.") }
        if UIKit.UIImage(named: "facebook.png", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'facebook.png' is used in storyboard 'Signup', but couldn't be loaded.") }
        ...
        if #available(iOS 11.0, tvOS 11.0, *) {
          ...
          if UIKit.UIColor(named: "Grey", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Color named 'Grey' is used in storyboard 'Signup', but couldn't be loaded.") }
        ...
        if _R.storyboard.signup().loginViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'loginViewController' could not be loaded from storyboard 'Signup' as 'LoginViewController'.") }
